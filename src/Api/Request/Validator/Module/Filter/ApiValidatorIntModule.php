...
/**
 * Class ApiValidatorIntModule
 *
 * @author Taras P. Girnyk <taras.p.gyrnik@gmail.com>
 */
class ApiValidatorIntModule extends AbstractApiValidatorModuleDecorator
{
    /**
     * @inheritDoc
     */
    public function validate(ServerRequestInterface $serverRequest, ApiParameterConfigInterface $parameterConfig)
    {
        ...
        foreach ($data as $name => $element) {
            if (null === ($filteredElement = filter_var($element, FILTER_VALIDATE_INT, FILTER_NULL_ON_FAILURE))) {
                return null;
            }
