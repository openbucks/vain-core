...
/**
 * Class ApiValidatorFloatModule
 *
 * @author Taras P. Girnyk <taras.p.gyrnik@gmail.com>
 */
class ApiValidatorFloatModule extends AbstractApiValidatorModuleDecorator
{
    /**
     * @inheritDoc
     */
    public function validate(ServerRequestInterface $serverRequest, ApiParameterConfigInterface $parameterConfig)
    {
        ...
        foreach ($data as $name => $element) {
            if (null === ($filteredElement = filter_var($element, FILTER_VALIDATE_FLOAT, FILTER_NULL_ON_FAILURE))) {
                return null;
            }
