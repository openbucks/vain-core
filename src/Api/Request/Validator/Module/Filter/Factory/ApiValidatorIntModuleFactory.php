...
use Vain\Core\Api\Request\Validator\Module\Filter\ApiValidatorIntModule;

/**
 * Class ApiValidatorIntModuleFactory
 *
 * @author Taras P. Girnyk <taras.p.gyrnik@gmail.com>
 */
class ApiValidatorIntModuleFactory implements ApiValidatorModuleFactoryInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        return new ApiValidatorIntModule($apiValidatorModule);
    }
}
