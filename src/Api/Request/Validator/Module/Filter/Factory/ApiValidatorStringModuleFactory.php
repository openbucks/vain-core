...
use Vain\Core\Api\Request\Validator\Module\Filter\ApiValidatorStringModule;

/**
 * Class ApiValidatorStringModuleFactory
 *
 * @author Taras P. Girnyk <taras.p.gyrnik@gmail.com>
 */
class ApiValidatorStringModuleFactory implements ApiValidatorModuleFactoryInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        return new ApiValidatorStringModule($apiValidatorModule);
    }
}
